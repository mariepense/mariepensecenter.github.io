...
$(window).on('scroll',function(){counter();});$(document).ready(function(){$('.has-animation').each(function(index){$(this).delay($(this).data('delay')).queue(function(){$(this).addClass('animate-in');});});});$(document).ready(function(){var sound=new Howl({src:["/audio/somewhereovertherainbow.mp3"],autoplay:true,volume:0.5,loop:true});sound.play();});})(jQuery);