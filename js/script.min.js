...
$(window).on('scroll',function(){counter();});var sound=new Howl({src:["/audio/somewhereovertherainbow.mp3"],autoplay:true,volume:0.5,loop:true});sound.pause();$(document).ready(function(){$('.has-animation').each(function(index){$(this).delay($(this).data('delay')).queue(function(){$(this).addClass('animate-in');});});if(window.location.pathname==="/"){sound.play();}});})(jQuery);